...
class ProductsList extends Component {
  ...
  async dataListRender() {
    try {
      const porducts = await new Parse.Query(
        Parse.Object.extend("Product")
      ).find();

      const items = porducts.map(item => {
        ...
        parsedItem["photo"] = item.get("photo")
          ? item.get("photo")._url
          : "https://ryanacademy.ie/wp-content/uploads/2017/04/product-placeholder.png";
        return parsedItem;
      });
        ...
        <div className="disable-text-selection">
          <Row>
            <Colxx xxs="12">
              ...
              <div className="mb-2">
                ...
                >
                  <IntlMessages id="products.display-options" />{" "}
          ...
          <Row>
            {filteredOrderedItems.length > 0 ? (
              filteredOrderedItems.map(product => {
